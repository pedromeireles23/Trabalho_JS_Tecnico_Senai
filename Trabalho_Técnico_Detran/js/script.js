...
function mudarnome() {
    ...
    console.log(tentativa2.childNodes.length)
     if (tentativa2.childNodes.length == 0) {
         tentativa2.innerHTML= '<br><label>Mudar nome do motorista:</label><input type="text" class="text" id ="nome1"><br><label>Mudar o número de habilitação:</label><input type="text" class="text" id="numero1">'
...
function capturar() {
    ...
    console.log(tentativa2);
     ...
     if(capturando2==='' && capturando===''){
        document.getElementById("tentativa2").innerHTML =''
        document.getElementById("tentativa2").innerHTML = document.getElementById("resultado").innerText;
     }
     else{
